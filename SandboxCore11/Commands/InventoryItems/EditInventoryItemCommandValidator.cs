namespace SandboxCore11.Commands
{
    ...
    public class EditInventoryItemCommandValidator : AbstractValidator<EditInventoryItemCommand>
    {
        private ApplicationDbContext db;

        public EditInventoryItemCommandValidator(ApplicationDbContext db)
        {
            this.db = db;
